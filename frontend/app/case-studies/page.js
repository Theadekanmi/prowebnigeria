            ...
            {caseStudies.map((study, index) => (
              ...
              >
                ...
                <div className={`relative ${index % 2 === 1 ? 'lg:col-start-1' : ''}`}>
                  <div className="relative bg-white rounded-3xl p-8 border border-neutral-200" style={{ boxShadow: '0 8px 30px rgba(0,0,0,0.08)' }}>
                    <div className="text-center">
                      <div className="w-20 h-20 bg-purple-100 rounded-2xl flex items-center justify-center mx-auto mb-6">
                        <study.results.primary.icon className="w-10 h-10 text-purple-600" />
                      </div>
      ...
      <section className="py-20 bg-neutral-900">
        <div className="container text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-neutral-900 font-semibold rounded-lg hover:bg-neutral-100 transition-colors"
            >
            ...
            <Link
              href="/services"
              className="inline-flex items-center gap-2 px-8 py-4 border border-neutral-700 text-white font-semibold rounded-lg hover:bg-neutral-800 transition-colors"
            >
