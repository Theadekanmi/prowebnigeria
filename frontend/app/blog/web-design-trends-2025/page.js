...
const trends = [
  ...
  },
  {
    ...
    description: 'With 85% of Nigerian internet users on mobile, mobile-first design is not a trend, it is a requirement. Thumb-friendly navigation is key.',
          ...
          <div className="max-w-4xl mx-auto">
            <article className="prose-blog">
              <section className="mb-12">
                ...
                <p>
                  Web design trends are not just about aesthetics. They reflect changing user expectations and technological capabilities. A website that looked modern in 2020 may feel dated today.
                </p>
                <p>
