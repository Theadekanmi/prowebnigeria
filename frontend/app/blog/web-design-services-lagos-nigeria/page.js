          ...
          <div className="max-w-4xl mx-auto">
            <article className="prose-blog">
              <section className="mb-12">
                ...
                <p>
                  Lagos is Nigeria's commercial capital with over 20 million residents and thousands of businesses competing for attention. In this crowded market, having a professional website is not optional. It is essential for survival and growth.
                </p>
                <p>
              ...
              <section className="mb-12">
                ...
                <div className="overflow-x-auto my-8">
                  <table className="w-full border-collapse">
                    ...
                    <tbody>
                      <tr><td className="p-4 border border-neutral-200">Custom Website</td><td className="p-4 border border-neutral-200">From ₦250,000</td><td className="p-4 border border-neutral-200">2-3 weeks</td></tr>
                      <tr className="bg-neutral-50"><td className="p-4 border border-neutral-200">Business Website</td><td className="p-4 border border-neutral-200">From ₦350,000</td><td className="p-4 border border-neutral-200">3-4 weeks</td></tr>
                      <tr><td className="p-4 border border-neutral-200">E-commerce Store</td><td className="p-4 border border-neutral-200">From ₦400,000</td><td className="p-4 border border-neutral-200">4-8 weeks</td></tr>
                    </tbody>
                  </table>
                </div>
              </section>
