...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-900 text-gray-300">
      ...
      {/* Main Footer Content */}
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-6 gap-6 mb-8">
          {/* Brand Column */}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center space-x-4">
              ...
              rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-purple-600 transition-all duration-300"
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 text-sm">
              <p>&copy; {currentYear} ProWeb Nigeria. All rights reserved. Powered by <a href="https://prowebnigeria.ng" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:text-purple-300 font-semibold transition-all">ProWeb Nigeria</a></p>
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-24 right-6 z-[60] w-12 h-12 bg-purple-600 text-white rounded-full shadow-lg hover:bg-purple-700 hover:shadow-xl transform hover:scale-110 transition-all duration-300 flex items-center justify-center"
